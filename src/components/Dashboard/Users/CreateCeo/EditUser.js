...
function EditUser() {
    ...
    const handleEdit = data => {
        ...
        if (id) {
            ...
            toast.error("пароль и пароль подтверждения не совпадают");
        }
    }
    ...
    return (
        ...
        <div class="wrap_first_page">
          <h1 class="main_title">Добовления и изменения цена</h1>
          ...
          <div class="triple_btn">
            <button class="w3-button w3-small w3-blue w3-round w3-ripple">Добавить</button>
            <button class="w3-button w3-small w3-red w3-round w3-ripple">Удалить</button>
            <button class="w3-button w3-small w3-indigo w3-round w3-ripple">Сохранить</button>
          </div>
          ...
          <div class="button_wrapper">
            <div class="left_btn_wrapper">
              <button class="w3-button w3-small w3-blue w3-round w3-ripple">Добавить</button>
              <button class="w3-button w3-small w3-green w3-round w3-ripple">Изменить</button>
              <button class="w3-button w3-small w3-red w3-round w3-ripple">Удалить</button>
            </div>
            <div class="right_btn_wrapper">
              <button class="w3-button w3-small w3-blue w3-round w3-ripple">Сохранить</button>
            </div>
          </div>
          ...
          <div class="save_btn">
            <button class="w3-button w3-small w3-blue w3-round w3-right w3-ripple">Сохранить</button>
          </div>
          <div>
        ...
        <div class="cards">
          ...
          <div class="card">
           ...
           <div class="text">
             ...
             <br/>
             Вы получаете; <br/>
             Логин:пароль / useragent и прокси от аккаунта на котором уже стоит дефолтный лимит
           </div>
         </div>
         <div class="card">
           <img src="../img/card.png" alt="" />
           <div class="text">
             BM Facebook $50 (Daily Limit) - 779p / $10 / 280грн
  
             BM позволит отливать вашу рекламу на $50 в день 
             
             - Вы получаете ссылку приглашение <br/>
             - Вводите рандомные(случайное) имя и данные  <br/>
             - Можно удалять админа <br/>
             - Принять в течении 2 дней после покупки  <br/>
             - Почта потверждена  <br/>
             - Замена в течении 24 часов после покупки в случае если получили бан при приеме  <br/>
