...
function CreateUser() {
    ...
    return (
        <form onSubmit={handleSubmit(handleCreate)}>
                    ...
                    <div className="d-flex align-center">
                        <div className="file-content">
                            <label>
                                ...
                                {errors.image && <span className="input_error">Обязательно поле</span>}
                            </label>
                            {file ? (
            ...
            <div>
                <label style={{ width: "314px" }}>
                    ...
                    <div className="input_primary_wrapper">
                        ...
                        <span onClick={handleShow} className="input_icon_wrap d-flex justify-center align-center">
            ...
            <div className="">
                {userSelect.map((f, i) => {
                    return <div className="mb-32" key={i}>
                        <label>{f.label}</label>
                        <RSelect
                            control={control}
                            width="200px"
            ...
            <div className="d-flex">
                <div>
                    <button type="submit" className="btn-main btn-main--dark mr-8">Сохранить</button>
                </div>
                <div className="ml-32"><button onClick={handleCancel} type="reset" className="btn-main">Отменить</button></div>
            </div>
        </form>
    )
}
