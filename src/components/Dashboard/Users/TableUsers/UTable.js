            ...
            case "actions":
                ...
                return (
                    <div className="table_actions d-flex">
                        {cell.row.original.role === 0 ? <Link to={`user/${cell.row.original.id}/edit`} className="mr-8"><Button icon={AdminImages.EditIcon} height="27px" padding="2px 5px" /></Link>
                            :
                            <Link style={{ opacity: ".7", pointerEvents: "none" }} className="mr-8"><Button icon={AdminImages.EditIcon} height="27px" padding="2px 5px" /></Link>}
                        <div><Button onClick={() => handleDelete(cell.row.original.id)} icon={AdminImages.TrashIcon} height="27px" padding="2px 5px" backgroundColor="#EB6D73" /></div>
                    </div>
                );
