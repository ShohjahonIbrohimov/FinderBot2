...
function OrderSideBar({ open, setOpen }) {
        ...
        <div>
            ...
            <div className="d-flex justify-between align-center mt-32">
                ...
                {statusSelect.map((f, i) => {
                    return (
                        <div className="ml-16 mb-24" key={i}>
            ...
            <div className="d-flex">
                ...
                <button onClick={() => { setOpen(false) }} className="btn-main mr-8">Закрыть</button>
            </div>
        </div>
    )
}
