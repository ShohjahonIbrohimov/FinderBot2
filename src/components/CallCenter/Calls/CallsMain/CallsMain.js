    ...
    return (
        <div>
            <div className={styles.row1}>
                <div className={styles.div1}><Rangepicker label={"Период"} /></div>
            ...
            <div className={styles.row2}>
                <div className={styles.sub_row1}>
                    <span>
                        Дата и время
                        <img className={styles.img_arrow_up_down} src={call_center_icons.up_down_arrow_icon} alt="" />
                    </span>
                    <span>
                        Тип
                        <img className={styles.img_arrow_up_down} src={call_center_icons.up_down_arrow_icon} alt="" />
            ...
            <div className={styles.thirdRow}>
                <div className={styles.no_sales}>Звонки не найдены или телефония не настроена</div>
                <div className={styles.create_sales}>Подключите телефонию в Центре интеграций</div>
            </div>
        </div>
    )
}
